...
[data-testid="stAppViewContainer"] {
    background:
        radial-gradient(ellipse 90% 60% at 25% 35%, rgba(110,40,220,0.30) 0%, transparent 65%),
        radial-gradient(ellipse 70% 50% at 75% 65%, rgba(60,20,180,0.35) 0%, transparent 65%),
        radial-gradient(ellipse 50% 40% at 50% 10%, rgba(140,60,255,0.18) 0%, transparent 60%),
...
.block-container {
    ...
    box-shadow: 0 8px 40px rgba(0,0,0,0.40), inset 0 1px 0 rgba(255,255,255,0.10) !important;
}
...
[data-testid="stFileUploader"] section *,
[data-testid="stFileUploaderDropzone"] * {
    color: rgba(210,190,255,0.80) !important;
}
/* 파일 업로더 Browse 버튼 */
...
[data-testid="stFormSubmitButton"] > div > div {
    width: 100% !important;
}
