...
[data-testid="stAppViewContainer"] {
    background:
        radial-gradient(ellipse 90% 60% at 25% 35%,
            rgba(110, 40, 220, 0.30) 0%, transparent 65%),
        radial-gradient(ellipse 70% 50% at 75% 65%,
            rgba(60, 20, 180, 0.35) 0%, transparent 65%),
        radial-gradient(ellipse 50% 40% at 50% 10%,
            rgba(140, 60, 255, 0.18) 0%, transparent 60%),
        linear-gradient(160deg, #020010 0%, #08001e 40%, #020012 70%, #0d0028 100%);
...
[data-testid="stAppViewContainer"]::before {
    ...
    background-image:
        ...
        radial-gradient(2px 2px at 50% 45%, rgba(180,120,255,0.4) 0%, transparent 100%),
        radial-gradient(1px 1px at 15% 75%, rgba(255,255,255,0.35) 0%, transparent 100%);
    pointer-events: none;
    z-index: 0;
}
...
p, div {
    ...
    color: rgba(220, 200, 255, 0.90) !important;
}
...
[data-testid="stTextInput"] input:focus {
    ...
    border-color: rgba(200, 140, 255, 0.70) !important;
    box-shadow: 0 0 0 3px rgba(160, 90, 255, 0.20) !important;
}
[data-testid="stTextInput"] input::placeholder {
    color: rgba(210, 190, 255, 0.35) !important;
...
[data-testid="stFileUploader"] section:hover {
    ...
    border-color: rgba(200, 140, 255, 0.45) !important;
}
[data-testid="stFileUploader"] section * {
    color: rgba(210, 190, 255, 0.70) !important;
    font-family: 'Pretendard', sans-serif !important;
}
...
[data-testid="stFormSubmitButton"] button {
    width: 100% !important;
    background: rgba(240, 232, 255, 0.93) !important;
...
[data-testid="stFormSubmitButton"] button:hover {
    ...
    box-shadow: 0 4px 24px rgba(130, 60, 255, 0.50) !important;
...
.hint-text {
    ...
    color: rgba(255, 210, 100, 0.82) !important;
    margin-top: -8px !important;
...
.custom-divider {
    width: 48px;
    height: 2px;
    background: linear-gradient(90deg, transparent, rgba(200,150,255,.7), transparent);
...
<div style="text-align:center; margin-bottom:4px;">
    <img src="data:image/png;base64,{LOGO_B64}"
         style="max-width:210px; max-height:52px; object-fit:contain;
                filter:drop-shadow(0 0 10px rgba(200,160,255,.5));">
</div>
<h2 style="text-align:center; color:#fff; font-family:'Pretendard',sans-serif;
           ...
           text-shadow:0 0 20px rgba(180,120,255,.9), 0 0 40px rgba(120,60,220,.5);">
    AI 경진대회 출품
</h2>
